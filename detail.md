...
* V2.2 : 기본 방법
  * 전반전(원금 소진 < 50%\[진행률])
    ...
    * (큰수LOC 매수) \[평단대비 10-(T/2)%]과 \[현재가 +15%] 비교하여 작은가격 0.5회치
    * (매도) \[평단 +10%]에 전체물량의 75% AFTER지정가 매도
    * (분할 매도2) \[평단대비 10-(T/2)%]에 전체물량 25% LOC매도
  * 후반전(원금 소진 >= 50%\[진행률])
    * (큰수LOC 매수) \[평단대비 10-(T/2)%]과 \[현재가 +15%] 비교하여 작은가격 1회치
    * (매도, 분할 매도2) 동일
* 쿼터손절 : 선택시 10분할로 변경됨
...
* 분할매도(매수 없음) :LOC로 매도만 하여 분할 손절하며 본장시작여부에 따라 매도가격이 다름(※손절 가능성 있음)
  * (종가LOC 매도) 전일종가 가격으로 0.5회치
  * (낮은수LOC 매도) 전일종가 가격보다 -10% 낮은가격으로 0.5회치
* 종가떨사(매도 없음)
