...
상세내역은 아래 URLO을 참고하세요.\[다계좌/자동화]를 눌러서 다인용 런처를 실행합니다.\[다계좌/자동화]를 눌러서 다인용 런처를 실행합니다.

[https://fragilememor.gitbook.io/kskyj-rpa-kium/launcher](https://fragilememor.gitbook.io/kskyj-rpa-kium/launcher)
...
문제 해결하기 > 에러상황 및 해결 참고해서 조치하시고, 그래도 안되는 경우 영웅문(HTS) 삭제하고, 폴더까지 삭제한 후에 재설치 하세요.
