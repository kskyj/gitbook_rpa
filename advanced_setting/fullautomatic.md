...
Full Automatic Mode(완전자동화) 등록시 다인용 런처에 설정된 내역으로 설정한 시간에 따라 사용자 순차대로 자동으로 동작합니다.가능 합니다.가능 합니다.가능 합니다.파란버튼만 누르면 한번에 완전자동화 등록이 가능하며, 사용자 이름이 없는 경우 완전자동화 등록시 건너 뜁니다.
